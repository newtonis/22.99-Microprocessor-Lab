...
def main():
    ...
    while True:
        ...
        if keys[pygame.K_a]:
            ...
            targetOrientacion -= 1
            texto = "ORIENTACION %d" % orientacion
            color = (0, 255, 0)
            rolido = 0
            cabeceo = 0
            orientacion = 0
        ...
        # yaw - orientacion
        glRotatef(targetOrientacion, 0, 1, 0)

        # roll - rolido
        glRotatef(targetRolido, 0, 0, 1)

        # pitch - cabeceo
        glRotatef(targetCabeceo, 1, 0, 0)
